...
1.  Install required Python packages:\
    `pip install ansible==12.3.0 jmespath==1.0.1`
...
3.  Configure the sample inventory and playbook:
    ...
    - Replace the `db2_subsystem` value with the target Db2 subsystem of your choice in the playbook ([schema_promotion.yml](schema_promotion.yml)).
